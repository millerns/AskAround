...
public class CreateQuestionActivity extends Activity {
	...
	private void setupQuestionTypeButtons() {		
		...
		commentOnlyButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				commentOnlyButton.setBackgroundColor(getResources().getColor(R.color.blue));
				singleChoiceButton.setBackgroundColor(getResources().getColor(R.color.white));
				multipleChoiceButton.setBackgroundColor(getResources().getColor(R.color.white));
		...
		singleChoiceButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				commentOnlyButton.setBackgroundColor(getResources().getColor(R.color.white));
				singleChoiceButton.setBackgroundColor(getResources().getColor(R.color.blue));
				multipleChoiceButton.setBackgroundColor(getResources().getColor(R.color.white));
		...
		multipleChoiceButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				commentOnlyButton.setBackgroundColor(getResources().getColor(R.color.white));
				singleChoiceButton.setBackgroundColor(getResources().getColor(R.color.white));
				multipleChoiceButton.setBackgroundColor(getResources().getColor(R.color.blue));
				answerChoice.setVisibility(View.VISIBLE);
				addOptionButton.setVisibility(View.VISIBLE);
				newOptionListView.setVisibility(View.VISIBLE);
